...
export function defensiveBlocStats(world: World, fid) {
...
export function offensiveBlocStats(world: World, fid) {
  const members = new Set([fid]);
...
export function settlementDefense(world: World, s) {
...
export function armyCap(world: World, fid) {
